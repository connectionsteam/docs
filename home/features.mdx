...
If you have already figured out what a connection is, you are in the right place, if not, see [What is a connection](/commands/config/connections.mdx).
Promotion or Promoted is a way to take your connection to the top of the list (literally), regardless of the number of votes your connection has. See extremely advanced metrics about your connection, unique audit logs, vote cooldown reduction, and much more.

We really recommend that you promote your connections that are part of a team of more than 1 member, as you will always want to keep your connection secure with the audit log, right?

<a href="https://connectionsbacia.squareweb.app/promote" target="_blank">
  <img height="200" noZoom src="/public/promotion.png"></img>
</a>

## Teams (And why they are so good)

Connections tem uma maneira muito fácil para você e seus amigos gerenciarem a mesma conexão (ou até mais de 1) no mesmo time. Isso é como gerenciar as suas conexões de uma maneira mais organizada e segura.

- **Team Connections**: Um time pode ter até 5 conexões de uma vez só, com cada membro do time podendo gerenciar cada uma.
- **Members**: Cada time pode ter até 3 membros em um time, e cada membro pode gerenciar o time, então tome cuidado com quem você coloca em seu time.
