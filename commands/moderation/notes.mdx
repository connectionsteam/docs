...
<Warning>Notes are removed after 30 days, take care</Warning>
...
<Info>
  When you add/remove a note to a user, Connections will automatically log the
  note in the logs channel
</Info>
